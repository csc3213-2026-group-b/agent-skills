...
If you've made it here then you probably know what Secure Payment Confirmation (SPC) is! If not, you can read more about it here: [URL](https://www.w3.org/TR/secure-payment-confirmation/)
